...
- **Recommended demo network:** Stellar testnet + Ethereum Sepolia and Base Sepolia are recorded full bridge-to-shield evidence paths. Arbitrum Sepolia and OP Sepolia are configured next-source routes, but need accepted hashes before demo claims.
