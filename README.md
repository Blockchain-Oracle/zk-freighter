...
> **Mainnet note:** Mainnet XLM/USDC SACs and Circle CCTP contract IDs have been verified read-only, and public mainnet XLM funding + USDC trustline + tiny XLM-to-USDC path-payment evidence is recorded. Mainnet shielded pools are not deployed/configured. See [`.thoughts/research/2026-06-25-mainnet-readiness.md`](.thoughts/research/2026-06-25-mainnet-readiness.md). No mainnet deploy, bridge, shield, or privacy claim should happen without explicit approval and recorded evidence.
