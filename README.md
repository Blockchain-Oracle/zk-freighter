...
- **Build mainnet-capable** — network is a config toggle (testnet ↔ mainnet, no code change); mainnet XLM has QuickShield, shielded transfer, and unshield evidence; mainnet USDC has QuickShield evidence; bridge-to-shield still needs separate evidence before demo claims.
...
- **Mainnet posture:** XLM/USDC pools are deployed/configured. Mainnet XLM QuickShield, XLM shielded transfer, XLM unshield, and USDC QuickShield are proven with accepted hashes. Mainnet USDC shielded transfer/unshield and bridge-to-shield must not be claimed until separate evidence is recorded.
