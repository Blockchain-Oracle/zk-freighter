...
> **Mainnet note:** Mainnet XLM/USDC SACs, Circle CCTP contract IDs, public USDC plumbing, ZK Fighter XLM/USDC pool deployments, and extension QuickShield XLM/USDC shield/deposit transactions are recorded. Mainnet shielded transfer, unshield/withdraw, and bridge-to-shield still need their own accepted hashes before being claimed. See [`.thoughts/research/2026-06-25-mainnet-readiness.md`](.thoughts/research/2026-06-25-mainnet-readiness.md) and [`.thoughts/research/spikes-log.md`](.thoughts/research/spikes-log.md).
...
- **Build mainnet-capable** — network is a config toggle (testnet ↔ mainnet, no code change); mainnet XLM/USDC QuickShield has evidence, while mainnet shielded transfer, unshield/withdraw, and bridge-to-shield still need separate evidence before demo claims.
...
- **Mainnet posture:** XLM/USDC pools are deployed/configured and mainnet XLM/USDC QuickShield is proven with accepted hashes. Mainnet shielded transfer, unshield/withdraw, and bridge-to-shield must not be claimed until separate evidence is recorded.
