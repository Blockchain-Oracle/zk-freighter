...
> **Mainnet note:** Mainnet XLM/USDC SACs and Circle CCTP contract IDs have been verified read-only, but mainnet shielded pools are not deployed/configured. See [`.thoughts/research/2026-06-25-mainnet-readiness.md`](.thoughts/research/2026-06-25-mainnet-readiness.md). No mainnet spend, deploy, bridge, or shield claim should happen without explicit approval and recorded evidence.
