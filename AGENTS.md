...
- Mainnet readiness research is recorded in `.thoughts/research/2026-06-25-mainnet-readiness.md`: mainnet XLM/USDC SACs and CCTP contract IDs are verified read-only, but mainnet shielded pools are not deployed/configured and mainnet spend/deploy still requires explicit approval.
