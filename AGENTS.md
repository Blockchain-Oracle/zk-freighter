...
- Mainnet readiness research is recorded in `.thoughts/research/2026-06-25-mainnet-readiness.md`: mainnet XLM/USDC SACs, Circle CCTP IDs, XLM/USDC privacy-pool deployments, and real extension XLM/USDC QuickShield shield/deposits are recorded. Mainnet shielded transfer, unshield/withdraw, and bridge-to-shield still require separate accepted hashes before claims.
